...
const int32_t BasicVRTPacket::MAX_PACKET_LENGTH = 65536*4;
const int32_t BasicVRTPacket::MAX_HEADER_LENGTH = 7*4;
const int32_t BasicVRTPacket::MAX_PKT_SPECIFIC_PROLOGUE_LENGTH = 10*4;
const int32_t BasicVRTPacket::MAX_PROLOGUE_LENGTH = BasicVRTPacket::MAX_HEADER_LENGTH + BasicVRTPacket::MAX_PKT_SPECIFIC_PROLOGUE_LENGTH;
const int32_t BasicVRTPacket::MAX_TRAILER_LENGTH = 1*4;
const int32_t BasicVRTPacket::MAX_PAYLOAD_LENGTH = BasicVRTPacket::MAX_PACKET_LENGTH - BasicVRTPacket::MAX_PROLOGUE_LENGTH - BasicVRTPacket::MAX_TRAILER_LENGTH;
